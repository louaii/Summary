...
class MovieController extends Controller
{
    ...
    public function index()
    {
        ...
        $genres = collect($genresArray)->mapWithKeys(function ($genre) {return [$genre['id'] => $genre['name']];});
    ...
    {
        return Http::withToken($this->tmdbToken)->get("https://api.themoviedb.org/3/{$endpoint}")->json();
    }
}
